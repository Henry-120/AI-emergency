    ...
    map.on("load", () => {
      ...
      map.addLayer({
        ...
        paint: {
          ...
          "circle-color": ["case", ["get", "nearest"], "#157f43", "#64748b"],
  ...
  return (
    <section className="overflow-hidden rounded-xl border border-line bg-surface">
      <div className="flex items-center justify-between border-b border-line px-4 py-3">
        <div>
          <div className="text-[11px] font-semibold text-accent">離線街道地圖</div>
          <div className="text-sm text-muted">MapLibre + PMTiles 本機街道底圖</div>
        </div>
